...
- If a new airline, operator, route endpoint, airport, model, or callsign family appears in a live aircraft-window case, update the relevant speech and fallback tables instead of relying on Latin spelling. Add or update `AIRLINE_SPEECH_RU`, aliases, known callsign/route fallbacks, airport speech tables, and focused tests as applicable.
